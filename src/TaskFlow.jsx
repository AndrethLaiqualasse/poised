        ...
        <div style={{ display: "flex", flexDirection: "column", height: 844, width: 390, margin: "0 auto", background: D.bg, position: "relative", overflow: "hidden", borderRadius: 16, border: `0.5px solid ${D.border}` }}>
          ...
          {showFab && (
            <button onClick={openNewTask} aria-label="New task"
              style={{ position: "absolute", bottom: 64, right: 14, width: 52, height: 52, borderRadius: "50%", background: D.accent, border: "none", color: "white", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: `0 2px 12px ${D.accentShadow}`, zIndex: 10 }}>
